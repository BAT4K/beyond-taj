      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0a0806] text-[#f5f0e8] px-4">
        <div className="bg-[#12100e] border border-red-900/30 p-8 rounded-sm text-center max-w-md shadow-2xl relative overflow-hidden">
          ...
          <div className="flex justify-center relative">
            <button onClick={() => generateJourney(journeyId)} className="relative z-10 px-8 py-3 border border-red-900/50 hover:bg-red-950/30 text-red-200 uppercase tracking-widest text-xs transition-colors rounded-sm cursor-pointer active:scale-95 active:opacity-80 touch-manipulation">
              Retry Generation
            </button>
          </div>
        </div>
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto mb-16 print:hidden">
          ...
          <div className="pt-6 flex flex-col md:flex-row justify-center items-center gap-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-10 py-4 uppercase tracking-widest text-sm font-bold rounded-sm bg-white/[0.05] border border-white/10 hover:border-[#25D366]/50 hover:bg-[#25D366]/10 hover:text-[#25D366] transition-colors cursor-pointer text-white w-full md:w-auto active:scale-[0.98] active:bg-[#25D366]/20 touch-manipulation"
            >
