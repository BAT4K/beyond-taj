...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        <span className="whitespace-nowrap">AI-Engineered Routing</span>
        <span className="text-white/40 hidden sm:inline">•</span>
        <span className="whitespace-nowrap">Bespoke Itineraries</span>
        <span className="text-white/40 hidden sm:inline">•</span>
        <span className="whitespace-nowrap">Secure Processing</span>
      </motion.div>
